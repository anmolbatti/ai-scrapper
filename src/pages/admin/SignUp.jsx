...
const Login = () => {
    ...
    const signUp = async (e) => {
        ...
        try {
            const user = await publicPost("/admin/new-user", {email, password}, navigate);
            if(user.status){
                toastRef.current.show({
                    type: "success",
                            ...
                            <h3>ai scrapper</h3>
                                ...
                                <div className="field_items">
                                    ...
                                    <svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_165_416)">
                                        <g clip-path="url(#clip1_165_416)">
                                        <g clip-path="url(#clip2_165_416)">
